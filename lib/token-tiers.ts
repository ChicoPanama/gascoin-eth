...
export const TOKEN_TIERS: TokenTier[] = [
  {
    ...
    max_eth_refund: 0.004, cooldown_days: 7, queue_priority: 4, badge_label: '',
    description: 'Hold 1 $GAS to access the platform.',
  ...
  },
  {
    ...
    max_eth_refund: 0.01, cooldown_days: 7, queue_priority: 3, badge_label: 'COMMUTER',
    description: 'Hold 100K $GAS to unlock Commuter status.',
  ...
  },
  {
    ...
    max_eth_refund: 0.02, cooldown_days: 3.5, queue_priority: 2, badge_label: 'ROAD WARRIOR',
    description: 'Hold 5M $GAS for Road Warrior status — 2 submissions per week.',
  ...
  },
  {
    ...
    max_eth_refund: 0.04, cooldown_days: 1.75, queue_priority: 1, badge_label: 'FLEET',
    description: 'Hold 10M $GAS for Fleet — 4 submissions per week, max rewards.',
