...
export const GATES: GateDefinition[] = [
  ...
  },
  {
    ...
    description: 'Your Solana wallet address must be physically written on the gas receipt in the photo.',
    what_we_check: 'OCR scan of receipt image searches for a string matching Solana address format (32-44 base58 characters). Extracted address is compared against the connected wallet.',
    common_failures: [
      'Address written too small to read clearly in photo',
      'Address written in pencil or light ink — low contrast',
      'Photo taken at an angle that distorts the text',
      'Address written on separate paper, not on the receipt',
      'Wrong wallet address — different from connected wallet',
    ],
    how_to_pass: 'Write your full wallet address clearly in black pen directly on the receipt. Write large enough to be readable. Double-check every character.',
    estimated_time_seconds: 45, is_blocking: true,
    checklist_label: 'My full wallet address is written clearly on the receipt',
  },
  {
