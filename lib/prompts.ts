...
═══ DECISION MATRIX ═══
- **approve**: all signals consistent, fraud scores below threshold, trust stable or improving, history clean. Dispatch ETH.
...
export const DEFAULT_GEMINI_RECEIPT = `You are the GASCOIN receipt verification engine. GASCOIN is an Ethereum-based gas refund protocol — users submit photos of real gas-station receipts to prove they paid for fuel, and receive ETH refunds based on tier and activity.
